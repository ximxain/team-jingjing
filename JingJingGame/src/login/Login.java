...
public class Login {
	...
	public void clickButton() {
		try {
			...
			String sql = "SELECT * FROM `jingjing_users` WHERE userId = " + "'" + user + "'" + "and pass = " + "'"
					+ pass + "'";
	...
	public void up() {
		...
		String sql = "UPDATE jingjing_currentStat SET grows = " + grows + ", exp =" + presentExperience + " , money ="
				+ money + ", grows = " + presentLevel + ", hungry = " + hungry + " , sick = " + sick
				+ " where userId ='" + user + "'";
		try {
