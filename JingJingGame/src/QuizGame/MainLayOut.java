...
public class MainLayOut {
	...
	public void changeStartPage() {
		try {
			...
			Parent login = FXMLLoader.load(getClass().getResource("/QuizGame/Quiz1.fxml"));
	...
	public void ClickQuiz1Correct() {
		...
		try {
			System.out.println(score);
			Parent login = FXMLLoader.load(getClass().getResource("/QuizGame/Quiz2.fxml"));
			Scene scene = new Scene(login);
	...
	public void ClickQuiz2Correct() {
		...
		System.out.println(score);
		try {
			Parent login = FXMLLoader.load(getClass().getResource("/QuizGame/Quiz3.fxml"));
			Scene scene = new Scene(login);
	...
	public void Quiz3CorrectAnswer() {
		if (Quiz3Answer.getText().equals(Quiz3)) {  //맞으면 +10
			...
			System.out.println(score);
			try {
				Parent login = FXMLLoader.load(getClass().getResource("/QuizGame/Quiz4.fxml"));
				Scene scene = new Scene(login);
	...
	public void ClickQuiz4Correct() {
		...
		System.out.println(score);
		try {
			Parent login = FXMLLoader.load(getClass().getResource("/QuizGame/Quiz5.fxml"));
			Scene scene = new Scene(login);
	...
	public void ClickQuiz5Correct() {
		...
		System.out.println(score);
		try {
			Parent login = FXMLLoader.load(getClass().getResource("/QuizGame/Quiz6.fxml"));
			Scene scene = new Scene(login);
	...
	public void ClickQuiz6Correct() {
		...
		System.out.println(score);
		try {
			Parent login = FXMLLoader.load(getClass().getResource("/QuizGame/Quiz7.fxml"));
			Scene scene = new Scene(login);
	...
	public void Quiz7CorrectAnswer() {
		if (Quiz7Answer.getText().equals(Quiz7)) {  //맞으면 +10
			...
			System.out.println(score);
			try {
				Parent login = FXMLLoader.load(getClass().getResource("/QuizGame/Quiz8.fxml"));
				Scene scene = new Scene(login);
	...
	public void ClickQuiz8Correct() {
		...
		System.out.println(score);
		try {
			Parent login = FXMLLoader.load(getClass().getResource("/QuizGame/Quiz9.fxml"));
			Scene scene = new Scene(login);
	...
	public void Quiz9CorrectAnswer() {
		if (Quiz9Answer.getText().equals(Quiz9)) {  //맞으면 +10
			...
			System.out.println(score);
			try {
				Parent login = FXMLLoader.load(getClass().getResource("/QuizGame/Quiz10.fxml"));
				Scene scene = new Scene(login);
	...
	public void ClickQuiz10Correct() {
		...
		if (score > 50) {  //score가 50 초과면 성공
			try {
				Parent login = FXMLLoader.load(getClass().getResource("/QuizGame/Pass.fxml"));
				Scene scene = new Scene(login);
			...
			try {
				Parent login = FXMLLoader.load(getClass().getResource("/QuizGame/Fail.fxml"));
				Scene scene = new Scene(login);
				Stage primaryStage = (Stage) Quiz10Correct.getScene().getWindow();
				primaryStage.setScene(scene);
			} catch (Exception e) {
